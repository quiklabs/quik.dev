...
export default styled(Badge)(({ theme, ownerState }) => {
  ...
  const indicatorStyles = (sizeProp: 'small' | 'medium' | 'large') => {
  ...
  const gradientStyles = (colorProp: 'primary' | 'secondary' | 'info' | 'success' | 'warning' | 'error' | 'light' | 'dark') => {
  ...
  const containedStyles = (colorProp: 'primary' | 'secondary' | 'info' | 'success' | 'warning' | 'error' | 'light' | 'dark') => {
